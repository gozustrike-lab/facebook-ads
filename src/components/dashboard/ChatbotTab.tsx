...
export function ChatbotTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Flow Diagram - Collapsible on mobile */}
      <CollapsibleSection
        value="flow-diagram"
      ...
      {/* Route Selector - Tabs on mobile, side-by-side on desktop */}
      {isMobile ? (
        <div className="space-y-3">
          <h3 className="text-sm font-semibold">Rutas de Derivación</h3>
          {/* Tab selector */}
          ...
          <motion.div
            ...
            className={`p-4 rounded-lg border-2 ${currentRoute.color}`}
          >
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xl">{currentRoute.flag}</span>
              <h4 className="font-semibold text-sm">{currentRoute.label}</h4>
            </div>
            <p className="text-xs text-muted-foreground mb-3">{currentRoute.desc}</p>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-semibold">Rutas de Derivación</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {/* Chat Preview - Collapsible on mobile */}
      <CollapsibleSection
        value="chat-preview"
      ...
      {/* CPL Targets Configuration - Collapsible on mobile */}
      <CollapsibleSection
        value="cpl-targets"
        title="Objetivos CPL por Región"
