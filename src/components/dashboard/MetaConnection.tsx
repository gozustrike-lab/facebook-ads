...
export function MetaConnection() {
  ...
  const oauthMutation = useMutation({
    ...
    onSuccess: (datos) => {
      ...
      // Abrir la URL de OAuth en una nueva pestaña
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            {metaStatus?.accountId && (
              <div className="flex items-center gap-1.5 p-2 rounded border border-border">
                ...
                <span className="font-mono font-medium">{metaStatus.accountId}</span>
              </div>
            )}
            {metaStatus?.pixelId && (
              <div className="flex items-center gap-1.5 p-2 rounded border border-border">
                ...
                <span className="font-mono font-medium">{metaStatus.pixelId}</span>
              </div>
            )}
            {metaStatus?.businessId && (
              <div className="flex items-center gap-1.5 p-2 rounded border border-border">
                ...
                <span className="font-mono font-medium">{metaStatus.businessId}</span>
              </div>
            )}
            ...
            {metaStatus?.lastSyncAt && (
              <div className="flex items-center gap-1.5 p-2 rounded border border-border col-span-2">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {metaStatus?.connected && (
              <Button
                size="sm"
                variant="outline"
                className="gap-1.5 text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950"
        ...
        {/* ============================================= */}
        <Collapsible open={credencialesAbiertas} onOpenChange={setCredencialesAbiertas}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" size="sm" className="w-full justify-between gap-2">
              ...
              <ChevronDown className={`h-4 w-4 transition-transform ${credencialesAbiertas ? 'rotate-180' : ''}`} />
            </Button>
          </CollapsibleTrigger>
        ...
        {/* ============================================= */}
        {/* SECCIÓN 4: Registro de Actividad */}
        {/* ============================================= */}
